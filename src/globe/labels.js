...
export function updateLabels(camera, frustum, effZoom) {
  ...
  for (const l of labels) {
    if (effZoom < l.minZoom || effZoom > l.maxZoom) continue;
  ...
  // 국가/산맥처럼 낮은 줌에서 의미 있는 라벨을 먼저 두고, 같은 계층이면 화면 중앙에 가까운 라벨 우선.
  candidates.sort((a, b) => a.l.minZoom - b.l.minZoom || a.l.priority - b.l.priority || b.dot - a.dot);
